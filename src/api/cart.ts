  ...
  cartApi.post('/merge-guest-and-customer', (req, res) => {
    ...
    client.addMethods('cart', (restClient) => {
      ...
      module.mergeGuestAndCustomer = function () {
        ...
        return restClient
          .post(
            `cart/mergeGuestAndCustomer?token=${customerToken}&cartId=${req.query.cartId}`,
            undefined,
            userAgent
          )
          .then((data) => {
